...
export const columns = ({ onAddPayment, onAddPurchase, onEdit, onViewDetails }: ColumnsProps): ColumnDef<Supplier>[] => [
  {
    id: "select",
    header: ({ table }) => (
      <CustomCheckbox
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem onClick={() => onAddPayment(supplier)}>تسديد دفعة</DropdownMenuItem>
            <DropdownMenuItem onClick={() => onAddPurchase(supplier)}>إضافة شراء</DropdownMenuItem>
            <DropdownMenuItem onClick={() => onViewDetails(supplier)}>عرض التفاصيل</DropdownMenuItem>
            <DropdownMenuSeparator />
